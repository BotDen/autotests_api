...
from tools.assertions.file import assert_file
...
def assert_get_courses_response(
    ...
    create_course_responses: list[CreatedCourseResponseSchema],
):
    """
    ...
    assert_lens(get_courses_response.courses, create_course_responses, "courses")
...
def assert_create_course_response(response: CreatedCourseResponseSchema, request: CreateCourseRequestSchema):
    """
